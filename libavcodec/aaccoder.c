...
#include <ffmpeg/libavutil/libm.h> // brought forward to work around cygwin header breakage
...
#include <ffmpeg/libavcodec/aaccoder_twoloop.h>
...
#include <ffmpeg/libavcodec/aaccoder_trellis.h>
